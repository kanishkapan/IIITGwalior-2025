...
export const bookAppointment = async (req, res) => {
  try {
    ...
    const appointment = new Appointment({ studentId, doctorId, date, timeSlot });
...
export const getStudentAppointments = async (req, res) => {
  try {
    ...
    const appointments = await Appointment.find({ studentId }).populate("doctorId", "name email");
...
export const getDoctorAppointments = async (req, res) => {
  try {
    ...
    const appointments = await Appointment.find({ doctorId }).populate("studentId", "name email");
